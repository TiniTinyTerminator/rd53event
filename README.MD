Here is an updated README that reflects that your project uses CMake for building both the C++ library and the Python bindings:
...
2. **Configure and Build the Python Bindings**
   ...
   make RD53Eventpy
   # optional packaging and install and install
   make package-python
   make install-python
   ```
